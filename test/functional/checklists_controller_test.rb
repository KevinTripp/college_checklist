...
class ChecklistsControllerTest < ActionController::TestCase
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post :create, checklist: { completed: @checklist.completed, date_complete: @checklist.date_complete, due_date: @checklist.due_date, name: @checklist.name }
    end
  ...
  test "should update checklist" do
    put :update, id: @checklist, checklist: { completed: @checklist.completed, date_complete: @checklist.date_complete, due_date: @checklist.due_date, name: @checklist.name }
    assert_redirected_to checklist_path(assigns(:checklist))
  end
