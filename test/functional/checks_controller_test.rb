...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { completed: @check.completed, date_complete: @check.date_complete, due_date: @check.due_date, name: @check.name }
    end
  ...
  test "should update check" do
    put :update, id: @check, check: { completed: @check.completed, date_complete: @check.date_complete, due_date: @check.due_date, name: @check.name }
    assert_redirected_to check_path(assigns(:check))
  end
